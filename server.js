...
app.listen(PORT, () => console.log(`Server live on port ${PORT}`));mongoose.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/shopnest')
  .then(async () => {
    console.log('✅ MongoDB connected');
    await seedData();
    app.listen(PORT, () => {
      console.log(`\n🚀 ShopNest running at http://localhost:${PORT}`);
    });
  })
